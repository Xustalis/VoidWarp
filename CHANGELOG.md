...
### Enhancements 🚀
- Windows UI branding: transfer window title/message box uses `voidwarp`

### FFI Hardening 🛡️
- Tightened `receiver_accept` argument validation and simplified error handling
- Removed redundant/unused folder-transfer fields and reduced noisy FFI logging
- Simplified TCP ping timeout handling to explicit `true/false` results
